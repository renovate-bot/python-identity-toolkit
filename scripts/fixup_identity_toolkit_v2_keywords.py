...
class identity_toolkitCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=identity_toolkitCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the identity_toolkit client library.
